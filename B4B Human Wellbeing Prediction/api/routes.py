...
def register(app, schema):
    ...
    def predict():
        """
        Predict route takes in a json object and appends it to the prediction_data array.
        It then uses that array to make a prediction using the t-pot model and returns the prediction + shap.
        Returns:
            Json object with the prediction and shap data
        """
