...
# This model predicts the solar production of the solar panels, based on the weather data.
# Current model will used generated data from a file. So, this is preprocessed to be fast.
#
# Future improvements:
